...
sender=st.text_input('Please input Sender: ')
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver=st.text_input('Please input Receiver: ')

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount=st.slider('Please input amount: ')
...
if st.button("Add Block"):
    ...
    new_block = Block(record=new_record, timestamp=datetime.datetime.utcnow().strftime("%H:%M:%S"), creator_id=42, prev_hash=prev_block_hash)
